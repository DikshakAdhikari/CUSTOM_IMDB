  ...
  return (
    <div className="w-[1000px] rounded-[10px] shadow-md flex flex-col overflow-hidden bg-white">
      ...
      {movies.map((movie) => (
        <div
          key={movie._id}
          className="flex items-center h-[70px] m-[50px 10px] shadow-md cursor-pointer transition-all duration-100 ease-linear bg-white rounded-[4px]    transform scale-101 hover:scale-105"
        >
